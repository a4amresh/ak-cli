...
const TemplatesList_1 = tslib_1.__importDefault(require("./TemplatesList"));
...
async function parseMissingOptions(options) {
    ...
    return Object.assign({}, options, { template: options.template || answers.template, projectDir: options.projectDir || answers.projectDir, git: options.git || answers.git });
}
